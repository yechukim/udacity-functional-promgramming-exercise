...
const {merge, List} = require("immutable");
...
const map1Update = map1.set('name', 'Mal').set('Pilot', 'Captain')
//console.log(map1Update.toJS())
...
// 2. Add a character
const myList3 = myList2.push('mario')
//console.log(Array.from(myList3))
